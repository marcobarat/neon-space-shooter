...
export const WORLDS = [
  ...
  },
  {
    ...
    star: "#d0f0cc",
    enemy: { straight: "#4dffa6", zigzag: "#b6ff3f", shooter: "#3fd0ff", tank: "#c8b06a", kamikaze: "#ff9a3f", splitter: "#8bff6a", sniper: "#3fd0ff", mine: "#b6ff3f" },
    boss: "#ffae3f",
    scene: "asteroids",
    pool: ["straight", "zigzag", "tank", "kamikaze"],
    bossType: "serpent",
  },
  {
  ...
  },
  {
    ...
    star: "#bfeee8",
    enemy: { straight: "#3fffe0", zigzag: "#ffd23f", shooter: "#c56bff", tank: "#6ad0c0", kamikaze: "#ff4d6d", splitter: "#3fffe0", sniper: "#c56bff", mine: "#6affd0" },
    boss: "#ff3860",
    scene: "void",
    pool: ["tank", "sniper", "splitter", "mine", "kamikaze"],
    bossType: "laser",
  },
];
